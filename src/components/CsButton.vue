<template>
  <div>
    <button v-on:click="upFunction" class="btn btn-primary">
      <svg
        width="2em"
        height="2em"
        viewBox="0 0 16 16"
    ...
    <button v-on:click="downFunction" class="btn btn-success ml-3">
      <svg
        width="2em"
        height="2em"
        viewBox="0 0 16 16"
    ...
    <button v-on:click="LoveFunction" class="btn btn-danger ml-3">
      <svg
        width="2em"
        height="2em"
        viewBox="0 0 16 16"
    ...
    <button v-on:click="ResetFunction" class="btn btn-light ml-3">
      <svg
        width="2em"
        height="2em"
        viewBox="0 0 16 16"
